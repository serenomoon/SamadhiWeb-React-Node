...
export const DataClasesActualizar = () => {
    ...
    const { startSavingClase, activeClase } = useClaseStore();
    const { title, message, uploadimg, id, onInputChange }  = useForm( activeClase );
    ...
    const claseSubmit = ( event ) => {
        ...
        startSavingClase( { title: title, message: message, uploadimg: uploadimg, id: id, date: new Date() })
